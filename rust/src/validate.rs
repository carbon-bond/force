...
pub trait ValidatorTrait {
    fn validate_bond(bondee: &Bondee, data: &Value) -> bool;
    fn validate_datatype(data_type: &DataType, data: &Value) -> bool {
    ...
    fn validate_category(category: &Category, data: &Value) -> bool {
...
mod tests {
    ...
    impl ValidatorTrait for Validator {
        fn validate_bond(_bondee: &Bondee, _data: &Value) -> bool {
            true // 測試中不檢查
        }
    }
    #[test]
